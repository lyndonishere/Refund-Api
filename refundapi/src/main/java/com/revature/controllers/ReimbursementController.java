...
public class ReimbursementController {
    ...
    public Handler getHelloWorld = ctx -> {
     ...
     public Handler getAllReimbursements = ctx -> {
        List<Reimbursement> reimbursement =  this.reimbursementService.serviceGetAllReimbursements();
     ...
     public Handler deleteReimbursement = ctx -> {
       ...
       public Handler updateReimbursement = ctx -> {
        try {
           ...
           Reimbursement result = this.reimbursementService.serviceUpdateReimbursement(updatedReimbursement);
       ...
       public Handler createReimbursement = ctx -> {
        try{
           ...
           Reimbursement result = this.reimbursementService.serviceAddReimbursement(newReimbursement);
           String resultJson = this.gson.toJson(result);
           ctx.result(resultJson);
           ctx.status(201);
       } catch(InvalidReimbursement e){
